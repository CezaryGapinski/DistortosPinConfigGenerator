...
#ifndef SOURCE_BOARD_STM32_NUCLEO_L073RZ_CUSTOM_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
#define SOURCE_BOARD_STM32_NUCLEO_L073RZ_CUSTOM_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
...
/// index of blue_button
constexpr size_t blue_button { 0 };
