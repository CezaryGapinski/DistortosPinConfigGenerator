...
#ifndef SOURCE_BOARD_STM32_NUCLEO-L073RZ_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
#define SOURCE_BOARD_STM32_NUCLEO-L073RZ_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
...
constexpr size_t totalButtons { 1 };
...
/// index of onboard_button
constexpr size_t onboard_buttonIndex { 0 };
