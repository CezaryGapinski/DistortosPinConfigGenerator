 ...
 *
 * \file
 * \brief Declaration of buttons for CUSTOM-BOARD
 *
...
#ifndef SOURCE_BOARD_STM32_STM32F1_CUSTOM_BOARD_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
#define SOURCE_BOARD_STM32_STM32F1_CUSTOM_BOARD_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
...
/// indicates whether B2 button is enabled (1) or not (0)
#ifdef CONFIG_CHIP_STM32_GPIOV1_GPIOB_ENABLE
#define DISTORTOS_BOARD_B2_BUTTON_ENABLE	1
#else	// !def CONFIG_CHIP_STM32_GPIOV1_GPIOB_ENABLE
#define DISTORTOS_BOARD_B2_BUTTON_ENABLE	0
...
#define DISTORTOS_BOARD_TOTAL_BUTTONS	\
	...
	DISTORTOS_BOARD_B2_BUTTON_ENABLE	+	\
	0
...
#if DISTORTOS_BOARD_B2_BUTTON_ENABLE == 1
		/// index of B2 button
		b2ButtonIndex,
#endif	// DISTORTOS_BOARD_B2_BUTTON_ENABLE == 1
};
...
#endif	// SOURCE_BOARD_STM32_STM32F1_CUSTOM_BOARD_INCLUDE_DISTORTOS_BOARD_BUTTONS_HPP_
